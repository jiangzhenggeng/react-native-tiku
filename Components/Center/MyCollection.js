...
export default class extends Component {
    ...
    render() {
        let header = (
            <View style={[styles.header,styles.borderFix,{justifyContent:'flex-start'}]}>
                ...
                <Text style={[styles.title]}>收藏试题</Text>
            </View>
        );
    ...
    componentDidMount() {
        HttpRequest.request(UrlConfig.get_collection_subject_list,{
    ...
    intoSubjectList(item){
        ...
        this.navigate('Common/DoQuestion/DoQuestion',{
            getQuestionUrl:UrlConfig.CollectionQuestionList,
            getQuestionDetail:UrlConfig.CollectionQuestionDetail,
            data:{
                memberid:global.memberid,
